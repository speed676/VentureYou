  ...
  <body class="  ">
    <div class="bg-dark dk" id="wrap">
      ...
      <%@ include file="components/menuAdmin.jsp" %>  
		...
		<div class="main-bar">
            <h3>
              <i class="fa fa-dashboard"></i>&nbsp; Dar de alta un nuevo gerente</h3>
          </div><!-- /.main-bar -->
      </div><!-- /#top -->
              ...
              <div class="col-lg-12">
                <div class="box dark">
                  ...
                  <div id="div-1" class="body">
                    ...
                    <form:form enctype="multipart/form-data" modelAttribute="Gerente"  class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/admin1234/nuevoGerente.html">
	                   ...
	                   <div class="form-group">
	                    	<form:label path="usuario" for="usuario" class="control-label col-lg-3">Usuario</form:label>
		                    <div class="col-lg-7">
		                    	<form:input path="usuario" tabindex="1" type="text" id="usuario" placeholder="Nombre de usuario" class="form-control"/>
		                    </div>
	                    </div><!-- /.form-group --> 
					...
					<div class="form-group">
	                    	<form:label path="contrasenya" for="contrasenya" class="control-label col-lg-3">Contraseña</form:label>
		                    <div class="col-lg-7">
		                    	<form:input path="contrasenya" tabindex="2" type="password" id="contrasenya" placeholder="Contraseña" class="form-control"/>
		                    </div>
	                    </div><!-- /.form-group -->
